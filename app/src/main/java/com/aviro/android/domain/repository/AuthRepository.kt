...
interface AuthRepository {
    ...
    suspend fun getSignTypeFromLocal() : String
    suspend fun saveSignTypeToLocal(type : String)
    suspend fun removeSignTypeFromLocal()
    ...
    suspend fun getUser(user_id : String) : MappingResult
